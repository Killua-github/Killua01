...
> Arguments
> - light; "LD" to make a LD light information figure, "DD" to make a DD light information figure
> - colour; "B" to only make a blue arrow for a tempareture information figure, "R" to only make a red arrow for a tempareture information figure, "BRB" to make a blue-red-blue arrow for a tempareture information figure, "RBR" to make a red-blue-red arrow for a tempareture information figure
> - temp1; (first) tempareture written in number
...
`StTest(LD)`
> Arguments
> - LD; "L" for selecting the first half of a day, "D" for selecting the second half of a day
